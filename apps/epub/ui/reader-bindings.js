...
function create({elements:E,reader,navigation,annotationModes}={}){
 ...
 async function requestOpen(){if(!(await authorizeReplacement('open')))return false;if(g.InkDOSFileLaunch?.requestPicker?.(E.file))return true;E.file.click();return true}
