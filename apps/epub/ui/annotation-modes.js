...
function create({reader,session,elements}={}){
 ...
 return Object.freeze({install,finalizeLegacySelectionUi,state:()=>Object.freeze({mode,color,noteOpen:!backdrop.hidden})});
}
