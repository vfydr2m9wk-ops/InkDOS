...
function install(target=document.getElementById('editbar')){
  ...
  return Object.freeze({target,left,right,sync,dispose(){ro?.disconnect();mo.disconnect();global.removeEventListener('resize',sync)}})
}
NS.ToolbarRail=Object.freeze({install});
})(globalThis);
