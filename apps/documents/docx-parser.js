...
function cssRun(props){let css='';if(props.fontFamily)css+="font-family:'"+String(props.fontFamily).replace(/[\\']/g,'')+"',Arial,sans-serif;";if(props.fontSizePt)css+='font-size:'+props.fontSizePt+'pt;';if(props.bold)css+='font-weight:700;';if(props.italic)css+='font-style:italic;';if(props.underline)css+='text-decoration:underline;';if(props.color)css+='color:'+props.color+';';return css}
