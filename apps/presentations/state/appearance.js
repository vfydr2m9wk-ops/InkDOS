...
const NS=global.InkDOS2Presentations=global.InkDOS2Presentations||{},KEY='inkdos2:presentations:appearance',SUITE_KEY='inkdos2:appearance',VALID=new Set(['light','dark','system']);
let mode='system',media=null,listener=null,storageListener=null;
try{const shared=localStorage.getItem(SUITE_KEY),saved=localStorage.getItem(KEY);if(VALID.has(shared))mode=shared;else if(VALID.has(saved))mode=saved}catch(_){}
