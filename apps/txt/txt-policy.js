...
function isSupportedName(name){return SUPPORTED.includes(extension(name))}
...
NS.TxtPolicy=Object.freeze({SUPPORTED,accept,apply,isSupportedName,isXmlName,declaredXmlEncoding,xmlEncodingCompatible,xmlEncodingLabel,assertXmlStorage});
})(globalThis);
