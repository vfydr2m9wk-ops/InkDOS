...
recovery=window.InkDeskLocalRecovery?InkDeskLocalRecovery.create({module:'spreadsheets',appVersion:'0.20.2.1',defaultFileName:'Untitled.xlsx',serialize:captureSpreadsheetRecovery,restore:restoreSpreadsheetRecovery,status:message=>{if(message&&/failed/i.test(message))toast(message)}}):null;
