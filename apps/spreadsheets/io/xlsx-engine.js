...
function cloneCell(cell){
  if(!cell)return null;
  return{v:cell.v,f:cell.f||'',styleId:+(cell.styleId||0),style:cell.style?JSON.parse(JSON.stringify(cell.style)):{},t:cell.t||'',display:cell.display??''};
}
function sameCell(a,b){
  if(!a&&!b)return true;if(!a||!b)return false;
  return String(a.f||'')===String(b.f||'')&&String(a.t||'')===String(b.t||'')&&Number(a.styleId||0)===Number(b.styleId||0)&&JSON.stringify(a.style||{})===JSON.stringify(b.style||{})&&String(a.v??'')===String(b.v??'');
}
