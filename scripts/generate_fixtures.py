#!/usr/bin/env python3
"""Generate tiny, redistributable OOXML fixtures for repository tests."""
...
def package(name: str, parts: dict[str, str]) -> None:
    with ZipFile(OUT / name, "w", ZIP_DEFLATED) as archive:
        for path, content in parts.items():
            archive.writestr(path, content.strip())


def main() -> None:
    package("minimal.docx", {
        ...
        "word/document.xml": """<?xml version="1.0"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>InkDOS fixture</w:t></w:r></w:p><w:sectPr/></w:body></w:document>""",
    })
    package("minimal.xlsx", {
        ...
        "xl/worksheets/sheet1.xml": """<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" t="inlineStr"><is><t>InkDOS fixture</t></is></c></row></sheetData></worksheet>""",
    })
    package("minimal.pptx", {
        ...
        "ppt/slides/slide1.xml": """<?xml version="1.0"?><p:sld xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><p:cSld><p:spTree><p:nvGrpSpPr><p:cNvPr id="1" name=""/><p:cNvGrpSpPr/><p:nvPr/></p:nvGrpSpPr><p:grpSpPr/></p:spTree></p:cSld></p:sld>""",
    })
