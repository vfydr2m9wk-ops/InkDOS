...
def main() -> None:
    package("minimal.docx", {
        ...
        "word/document.xml": """<?xml version="1.0"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>InkDesk fixture</w:t></w:r></w:p><w:sectPr/></w:body></w:document>""",
    })
    package("minimal.xlsx", {
        ...
        "xl/worksheets/sheet1.xml": """<?xml version="1.0"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetData><row r="1"><c r="A1" t="inlineStr"><is><t>InkDesk fixture</t></is></c></row></sheetData></worksheet>""",
    })
