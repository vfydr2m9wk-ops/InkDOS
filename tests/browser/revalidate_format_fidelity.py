...
def load_documents(page):
    ...
    for rel in ('apps/documents/styles.css', 'shared/office-shell.css', 'shared/ui/visual.css', 'shared/ui/content.css', 'shared/ui/workspace.css'):
...
def load_presentations(page):
    ...
    for rel in ('apps/presentations/styles.css', 'shared/office-shell.css', 'shared/ui/visual.css', 'shared/ui/workspace.css'):
        page.add_style_tag(path=str(ROOT / rel))
