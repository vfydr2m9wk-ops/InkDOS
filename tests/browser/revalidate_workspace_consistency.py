...
def main():
    ...
    with sync_playwright() as pw:
        ...
        page.wait_for_function("window.InkDOSSpreadsheetFormulaEditor && window.InkDOSSpreadsheetFormulaEditor.hasPendingDrafts()")
        page.click('#saveBtn')
