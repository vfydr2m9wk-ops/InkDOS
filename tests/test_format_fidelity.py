...
class FormatFidelityCorrection02031Tests(unittest.TestCase):
    def test_documents_loads_drawing_layout_before_parser(self):
        ...
        self.assertIn('drawing-layout.js?v=1.0.0-beta.6', html)
        self.assertLess(html.index('drawing-layout.js?v=1.0.0-beta.6'), html.index('docx-parser.js?v=1.0.0-beta.6'))
    ...
    def test_presentations_loads_background_resolver_before_app(self):
        ...
        self.assertIn('engine/background-resolver.js?v=1.0.0-beta.6', html)
        self.assertLess(html.index('engine/background-resolver.js?v=1.0.0-beta.6'), html.index('app.js?v=1.0.0-beta.6'))
