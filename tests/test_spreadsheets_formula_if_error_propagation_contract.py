...
const sheet={{name:'Sheet1',cells:new Map([['A1',{{v:'#DIV/0!',t:'e'}}],['A2',{{v:'',t:'n',f:'A1'}}],['A3',{{v:0,t:'n'}}],['A4',{{v:1,t:'n'}}]])}}; const book={{sheets:[sheet]}};
...
expect('IF(A1,1,2)','#DIV/0!');
expect('IF(A2,1,2)','#DIV/0!');
expect('IF(A3,1,2)',2);
expect('IF(A4,1,2)',1);
console.log('Spreadsheets IF condition error propagation contract: OK');'''
