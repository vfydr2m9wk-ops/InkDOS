...
def test_p5_background_control_survives_build_for_sync():
 ...
 assert "backgroundCtl=backgroundControl()" in s
 assert "pptBackgroundPopover" in s and "data-background-color" in s
 assert "colorControl('pptP1Background'" not in s
