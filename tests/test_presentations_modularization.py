...
class PresentationsModularizationTests(unittest.TestCase):
    def test_feature_components_load_before_app(self):
        ...
        components = (
            "state/selection-controller.js?v=0.20.2.14",
            "state/history-controller.js?v=0.20.2.14",
            "ui/inspector-controller.js?v=0.20.2.14",
            "ui/thumbnails-controller.js?v=0.20.2.14",
            "ui/presenter-notes-controller.js?v=0.20.2.14",
            "presentation/slideshow-controller.js?v=0.20.2.14",
            "io/pptx-write-adapter.js?v=0.20.2.14",
            "io/file-controller.js?v=0.20.2.14",
            "io/recovery-controller.js?v=0.20.2.14",
        )
        app = "app.js?v=0.20.2.14"
