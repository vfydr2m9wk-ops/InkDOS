...
class PresentationsModularizationTests(unittest.TestCase):
    def test_feature_components_load_before_app(self):
        ...
        components = (
            "state/selection-controller.js?v=0.20.2.13",
            "state/history-controller.js?v=0.20.2.13",
            "ui/inspector-controller.js?v=0.20.2.13",
            "ui/thumbnails-controller.js?v=0.20.2.13",
            "ui/presenter-notes-controller.js?v=0.20.2.13",
            "presentation/slideshow-controller.js?v=0.20.2.13",
            "io/pptx-write-adapter.js?v=0.20.2.13",
            "io/file-controller.js?v=0.20.2.13",
            "io/recovery-controller.js?v=0.20.2.13",
        )
        app = "app.js?v=0.20.2.13"
