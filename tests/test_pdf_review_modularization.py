...
class PdfReviewModularizationTests(unittest.TestCase):
    def test_review_boundary_is_explicit_precached_and_ratcheted(self):
        ...
        self.assertIn("review/annotation-layer.js?v=0.20.2.30", html)
        self.assertIn("review/review-controller.js?v=0.20.2.30", html)
        self.assertLess(
            html.index("review/annotation-layer.js?v=0.20.2.30"),
            html.index("review/review-controller.js?v=0.20.2.30"),
        )
        self.assertLess(
            html.index("review/review-controller.js?v=0.20.2.30"),
            html.index("viewer/page-renderer.js?v=0.20.2.30"),
        )
