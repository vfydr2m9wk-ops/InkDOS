...
class FormatFidelityCorrection02031Tests(unittest.TestCase):
    def test_documents_loads_drawing_layout_before_parser(self):
        ...
        self.assertIn('drawing-layout.js?v=1.0.0-beta.1', html)
        self.assertLess(html.index('drawing-layout.js?v=1.0.0-beta.1'), html.index('docx-parser.js?v=0.20.3.0'))
    ...
    def test_docx_parser_preserves_drawing_geometry_anchor_and_header_artwork(self):
        ...
        self.assertIn('InkDeskDocumentDrawingLayout.imageLayout(drawing', parser)
    ...
    def test_presentations_loads_background_resolver_before_app(self):
        ...
        self.assertIn('engine/background-resolver.js?v=1.0.0-beta.1', html)
        self.assertLess(html.index('engine/background-resolver.js?v=1.0.0-beta.1'), html.index('app.js?v=0.20.3.0'))
