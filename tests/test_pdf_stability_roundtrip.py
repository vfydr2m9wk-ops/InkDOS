...
def main():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as td,sync_playwright() as pw:
            ...
            page.goto(BASE+"/apps/pdf/",wait_until="load");page.wait_for_function("() => !!globalThis.InkDOS2PdfP4?.PdfStabilityDebug");page.add_script_tag(url=BASE+"/apps/pdf/vendor/pdf-lib/pdf-lib.min.js");page.wait_for_function("() => !!globalThis.PDFLib?.PDFDocument",timeout=15000);force_download_delivery(page)
            ...
            page.wait_for_function("() => globalThis.InkDOS2PdfP4.PdfStabilityDebug.layout.pageCount === 3");page.click("#editModeBtn");page.wait_for_function("() => document.documentElement.dataset.pdfMode === 'annotate'");page.evaluate("() => globalThis.InkDOS2PdfP4.PdfStabilityDebug.layout.goToPage(2)");page.wait_for_function("() => globalThis.InkDOS2PdfP4.PdfStabilityDebug.layout.currentPage === 2")
