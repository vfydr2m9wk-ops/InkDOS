...
class PdfSaveModularizationTests(unittest.TestCase):
    def test_save_boundary_is_explicit_precached_and_under_normal_limits(self):
        ...
        self.assertIn("io/save-controller.js?v=0.20.2.16", html)
        self.assertLess(
            html.index("flatten-export.js?v=0.20.2.16"),
            html.index("io/save-controller.js?v=0.20.2.16"),
        )
        self.assertLess(
            html.index("io/save-controller.js?v=0.20.2.16"),
            html.index("app.js?v=0.20.2.16"),
        )
