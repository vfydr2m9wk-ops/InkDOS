...
class TxtModuleTests(unittest.TestCase):
    ...
    def test_workspace_has_simple_editor_actions(self):
        ...
        self.assertIn(
            "../../shared/file-lifecycle.js?v=0.20.2.26",
            html,
        )
        self.assertIn(
            "../../shared/file-router.js?v=0.20.2.26",
            html,
        )
        self.assertIn(
            'history-controller.js?v=0.20.2.26',
            html,
        )
        self.assertIn(
            'find-controller.js?v=0.20.2.26',
            html,
        )
        self.assertLess(
            html.index('history-controller.js?v=0.20.2.26'),
            html.index('app.js?v=0.20.2.26'),
        )
        self.assertLess(
            html.index('find-controller.js?v=0.20.2.26'),
            html.index('app.js?v=0.20.2.26'),
        )
