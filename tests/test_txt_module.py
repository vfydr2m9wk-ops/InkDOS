...
class TxtModuleTests(unittest.TestCase):
    ...
    def test_workspace_has_simple_editor_actions(self):
        ...
        self.assertIn(
            "../../shared/file-lifecycle.js?v=1.0.0-beta.10",
            html,
        )
        self.assertIn(
            "../../shared/file-router.js?v=1.0.0-beta.10",
            html,
        )
        self.assertIn(
            'history-controller.js?v=1.0.0-beta.10',
            html,
        )
        self.assertIn(
            'find-controller.js?v=1.0.0-beta.10',
            html,
        )
        self.assertLess(
            html.index('history-controller.js?v=1.0.0-beta.10'),
            html.index('app.js?v=1.0.0-beta.10'),
        )
        self.assertLess(
            html.index('find-controller.js?v=1.0.0-beta.10'),
            html.index('app.js?v=1.0.0-beta.10'),
        )
        self.assertLess(
            html.index('../../shared/local-recovery.js?v=1.0.0-beta.10'),
            html.index('app.js?v=1.0.0-beta.10'),
        )
    ...
    def test_application_manifest_records_txt_contract(self):
        ...
        self.assertEqual(contract["version"], "1.0.0-beta.10")
