...
class DocumentsRulerDragModularizationTests(unittest.TestCase):
    ...
    def test_drag_controller_load_order_and_offline_precache(self):
        ...
        model_tag = "document-ruler-model.js?v=1.0.0-beta.10"
        drag_tag = "document-ruler-drag-controller.js?v=1.0.0-beta.10"
        layout_tag = "workspace-layout.js?v=1.0.0-beta.10"
    ...
    def test_architecture_ratchet_is_lowered(self):
        ...
        self.assertEqual(policy["release"], "1.0.0-beta.10")
...
if (!controller || controller.version !== '0.20.3.0') process.exit(12);
