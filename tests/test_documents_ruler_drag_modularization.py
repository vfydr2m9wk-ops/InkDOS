...
class DocumentsRulerDragModularizationTests(unittest.TestCase):
    ...
    def test_drag_controller_load_order_and_offline_precache(self):
        ...
        model_tag = "document-ruler-model.js?v=0.20.2.23"
        drag_tag = "document-ruler-drag-controller.js?v=0.20.2.23"
        layout_tag = "workspace-layout.js?v=0.20.2.23"
    ...
    def test_architecture_ratchet_is_lowered(self):
        ...
        self.assertEqual(policy["release"], "0.20.2.23")
...
if (!factory || factory.version !== '0.20.2.23') process.exit(10);
...
if (!controller || controller.version !== '0.20.2.23') process.exit(12);
