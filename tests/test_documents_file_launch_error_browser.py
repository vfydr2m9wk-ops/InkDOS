...
visible Documents error instead of failing silently (inkdos:file-launch-error)."""
...
VISIBLE="()=>{const e=document.getElementById('openErrorPanel');return !!e&&e.getBoundingClientRect().height>0&&!e.hidden?e.innerText:null}"
...
def main():
    ...
    print(f'Documents file-launch error visibility ({browser_name}): OK')
