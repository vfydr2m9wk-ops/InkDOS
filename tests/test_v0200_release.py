...
class ConsolidatedReleaseTests(unittest.TestCase):
    def test_public_version_is_consistent(self):
        ...
        self.assertEqual(package['version'], '0.20.2.8')
        self.assertEqual(manifest['version'], '0.20.2.8')
        self.assertEqual(release['version'], '0.20.2.8')
    ...
    def test_home_has_clean_six_workspace_layout(self):
        ...
        self.assertIn('InkDesk v0.20.2.8', html)
    ...
    def test_service_worker_matches_public_version(self):
        ...
        self.assertIn("const CACHE_NAME='inkdesk-shell-v0.20.2.8';", worker)
        for asset in (
            "'./apps/txt/index.html'",
