...
class ConsolidatedReleaseTests(unittest.TestCase):
    def test_public_version_is_consistent(self):
        ...
        self.assertEqual(version['version'], '0.20.2.19')
        self.assertEqual(package['version'], '0.20.2.19')
        self.assertEqual(manifest['version'], '0.20.2.19')
        self.assertEqual(release['version'], '0.20.2.19')
    ...
    def test_home_has_clean_six_workspace_layout(self):
        ...
        self.assertIn('InkDesk v0.20.2.19', html)
    ...
    def test_service_worker_matches_public_version(self):
        ...
        self.assertIn("const CACHE_NAME='inkdesk-shell-v0.20.2.19';", worker)
        for asset in (
            "'./apps/txt/index.html'",
    ...
    def test_development_state_is_reset_for_patch_series(self):
        ...
        self.assertEqual(state['appliedSequence'], 21)
        self.assertEqual(state['currentPackage'], '0.20.2.19')
