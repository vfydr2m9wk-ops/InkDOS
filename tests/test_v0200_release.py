...
class ConsolidatedReleaseTests(unittest.TestCase):
    def test_public_version_is_consistent(self):
        ...
        self.assertEqual(package['version'], '0.20.2.31')
        self.assertEqual(manifest['version'], '0.20.2.31')
        self.assertEqual(release['version'], '0.20.2.31')
    ...
    def test_home_has_clean_six_workspace_layout(self):
        ...
        self.assertIn('InkDesk v0.20.2.31', html)
    ...
    def test_service_worker_matches_public_version(self):
        ...
        self.assertIn("const CACHE_NAME='inkdesk-shell-v0.20.2.31';", worker)
        for asset in (
            "'./apps/txt/index.html'",
