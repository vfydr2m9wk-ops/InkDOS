(function (global) {
  ...
  function loadWorkspacePanelController() {
    if (
      ...
      global.InkDeskWorkspacePanelController.version === '0.20.2.30'
    ) {
  ...
  function loadDocumentRulerModel() {
    if (
      ...
      global.InkDeskDocumentRulerModel.version === '0.20.2.30'
    ) {
  ...
  function loadDocumentRulerDragController() {
    if (
      ...
      global.InkDeskDocumentRulerDragController.version === '0.20.2.30'
    ) {
  ...
  function loadDocumentSessionController() {
    if (
      ...
      global.InkDeskDocumentSessionController.version === '0.20.2.30'
    ) {
