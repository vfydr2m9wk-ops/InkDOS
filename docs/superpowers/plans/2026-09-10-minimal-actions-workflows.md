...
Expected paths are limited to `.github/workflows/**`, `tests/test_minimal_workflow_set_contract.py`, and this plan/spec documentation.
...
- [ ] **Step 1: Open a PR from `chore/minimal-actions` to `main`**
